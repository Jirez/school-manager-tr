...
const VerticalLayout = (props: any) => {
  ...
  // const [menuCollapsed, setMenuIsCollapsed] = useState(layoutStore.menuCollapsed)
  ...
  /*  useEffect(() => {
         setMenuIsCollapsed(overrideCollapsed ? layoutStore.menuCollapsed : ((size && size.width <= 1600)) && layoutStore.menuCollapsed)
     }, []) */
      ...
      {themeConfig.layout.scrollTop === true ? (
        <div className="scroll-to-top">
          <ScrollToTop
            showOffset={300}
            /* @ts-ignore desc*/
            className="scroll-top d-block mt-2 mb-1"
          >

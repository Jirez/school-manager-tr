 ...
 */
/*export const formatDate = (value: any, formatting = { month: 'short', day: 'numeric', year: 'numeric' }) => {
...
export const selectThemeColors = (theme: any) => ({
    ...
    colors: {
        ...
        neutral20: '#d9d9d9', // for input border-color
        neutral30: '#ededed' // for input hover border-color
    }
})

export const selectThemeErrorColors = (theme: any) => ({
    ...theme,
    colors: {
        ...theme.colors,
        primary25: '#7367f01a', // for option hover bg-color

...
import { useGuardianReligionsQuery } from '@/gql/graphql'
...
const GuardianReligionAutocomplete: React.FC<AutocompleteHintProps> = ({
  canRefetch = true,
  label,
  required,
  id,
  ...
  const { data, loading, refetch } = useGuardianReligionsQuery({
    ...
    <InputContainer className={className}>
      ...
      <InputWrapper>
        ...
        <AutocompleteHintInput
          options={data && data.guardianReligions ? data.guardianReligions : []}
          onFill={(value: string) => {
            props.onFill(value)
            setText(value)
          }}
...
export default GuardianReligionAutocomplete

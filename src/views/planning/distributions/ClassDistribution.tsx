...
import ClassDistributionAdd from '@/views/planning/distributions/ClassDistributionAdd'
...
const ClassDistribution = () => {
  ...
  useTitle(t('sidebar.planning.distribution'))
    ...
    <div className="flex flex-col w-full px-1 md:!px-0">
      <div>
        <div className="w-full">
          <PageHeader title={t('sidebar.planning.distribution')} />
        </div>
          ...
          <div className="w-full">
            <div className="card" style={{ marginTop: 20 }}>
              {loadingPlanning ? (
                ...
                <ClassDistributionAdd
                  distributions={dataPlanning?.distributions}
                  classId={clazz.id}
                />
              )}
            </div>

...
import {
  ...
  useAnnualDisciplineCalculationMutation,
  useAnnualDisciplinesCalculationMutation,
  useClassesForNoteQuery,
  useSchoolYearsQuery,
} from '@/gql/graphql'

const AnnualDisciplineCalculation = () => {
...
export default AnnualDisciplineCalculation

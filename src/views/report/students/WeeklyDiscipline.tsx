  ...
  return (
    <div className="flex flex-col w-full">
      <div className="w-full">
        <PageHeader title={t('label-weeklyDiscipline')} returnLink="/reports" />
      </div>
      <div className="w-full">
        <Select
      ...
      <div className="w-full mt-2">
        {values.clazz && (
          <PdfViewer
            url={`reports/weekly-discipline-${enterpriseId}.pdf?search=clazz:${buildOptions(
              values.clazz,
            )}`}
          />
        )}
...
export default WeeklyDiscipline

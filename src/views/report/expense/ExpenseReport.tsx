...
const ExpenseReport = () => {
  ...
  return (
    <ReportContainer>
      <PageHeader title={t('label-expenseReport')} />
      ...
      {show && (
        <PdfViewer
          url={`reports/expenses-${enterpriseId}.pdf?search=enterprise:${enterpriseId}${
            categories && categories.length > 0
              ? `,category:${buildPartialFilters(categories, 'id')}`
              : ''

  ...
  return (
    <div className="flex flex-col w-full">
      <div className="w-full">
        <PageHeader
          title={t('label-sequentialNthFirst')}
          returnLink="/reports"
        />
      </div>
      ...
      <div className="w-full mt-2">
        {values.subPeriod && debouncedValue && (
          <PdfViewer
            url={`reports/sequential-nth-first-${enterpriseId}-${values.subPeriod.id}.pdf?nth=${debouncedValue}&last=${values.last}&params=columnBorder:true,rowNumber:true,title:Liste des ${debouncedValue} premiers séquentiel`}
          />
        )}
      </div>
    </div>
...
export default SequentialNthFirst

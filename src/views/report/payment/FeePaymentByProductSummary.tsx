...
const FeePaymentByProductSummary = () => {
  ...
  const {
    ...
    title: t('sidebar.reports.studentPaymentByProductSummary'),
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="w-full mt-2">
        {show && (
          <PdfViewer
            url={`reports/fee-payment-product-summary-${enterpriseId}.pdf?search=enterprise:${enterpriseId}${
...
export default FeePaymentByProductSummary

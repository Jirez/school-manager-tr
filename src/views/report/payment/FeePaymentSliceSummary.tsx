  ...
  return (
    <div className="flex flex-col w-full">
      <div className="w-full">
        <PageHeader
          title={t('sidebar.reports.studentPaymentSummary')}
          //extra={<ReportButtons openModal={drawerAction.openModal} form={form} />}
          returnLink="/reports"
        />
      </div>
      <ReportOptions>
      ...
      <div className="w-full mt-2">
        {show && (
          <PdfViewer
            url={`reports/fee-payment-slice-summary-${enterpriseId}.pdf?search=enterprise:${enterpriseId}${
...
export default FeePaymentSliceSummary

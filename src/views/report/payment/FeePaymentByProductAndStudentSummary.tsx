...
const FeePaymentByProductAndStudentSummary = () => {
  ...
  const {
    ...
    title: t('sidebar.reports.studentPaymentByProductAndStudentSummary'),
  ...
  return (
    <div className="flex flex-col w-full">
        ...
        <Form onSubmit={methods.handleSubmit(onSubmit)}>
          <div className="grid gid-cols-1 md:grid-cols-12 gap-6 items-end">
            ...
            <Button
              type="submit"
              color="primary"
              className="round h-10 md:col-span-2"
            >
      ...
      <div className="w-full mt-2">
        {show && (
          <PdfViewer
            url={`reports/fee-payment-product-student-summary-${enterpriseId}.pdf?search=enterprise:${enterpriseId}${
...
export default FeePaymentByProductAndStudentSummary

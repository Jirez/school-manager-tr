...
const PaymentGroupReport = () => {
  ...
  const {
    ...
    title: t('label-studentsByPaymentGroup'),
    columnBorder: true,
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="w-full mt-2">
        {show && (
          <PdfViewer
            url={`reports/all-student-by-payment-group-${enterpriseId}.pdf?search=enterprise:${enterpriseId},${currentValues.search}&params=${params}
                `}
          />
        )}
      </div>
...
export default PaymentGroupReport

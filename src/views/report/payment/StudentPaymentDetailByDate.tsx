...
const StudentPaymentDetailByDate = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="w-full mt-2">
        {show && (
          <PdfViewer
            url={`reports/student-payment-detail-date-${enterpriseId}.pdf?search=enterprise:${enterpriseId}${
...
export default StudentPaymentDetailByDate

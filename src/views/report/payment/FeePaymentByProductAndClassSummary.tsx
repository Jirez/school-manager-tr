...
const FeePaymentByProductAndClassSummary = () => {
  ...
  const {
    ...
    title: t('sidebar.reports.studentPaymentByProductAndClassSummary'),
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="w-full mt-2">
        {show && (
          <PdfViewer
            url={`reports/fee-payment-product-class-summary-${enterpriseId}.pdf?search=enterprise:${enterpriseId}${
...
export default FeePaymentByProductAndClassSummary

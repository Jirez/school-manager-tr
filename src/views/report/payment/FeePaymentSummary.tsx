  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <ReportOptions>
        <Form onSubmit={methods.handleSubmit(onSubmit)} className="p-0">
          ...
          <ActionButtonsContainer>
            ...
            <ExportButton
              as="a"
              href={`${BASE_REPORT_URL}/reports/fee-payment-summary-${enterpriseId}.xlsx?search=enterprise:${enterpriseId}${
      ...
      <div className="w-full mt-2">
        {show && (
          <PdfViewer
            url={`reports/fee-payment-summary-${enterpriseId}.pdf?search=enterprise:${enterpriseId}${
              values.category && values.category.length > 0
                ? `,student:${buildOptions(values.category)}`
                : ''
            },${currentValues.search}&params=${params}

...
import DeductionCategoryDelete from './DeductionCategoryDelete'
...
export function useTableColumns(modal?: NiceModalHandler) {
  ...
  const columns: Array<ColumnDef<AppFeatures, DeductionCategoryType>> = useMemo(
    () => [
      {
      ...
      },
      {
        ...
        cell: (info) => (
          <div className="flex justify-center">
            <TypeBadge
              $color={info.getValue() ? 'danger' : 'secondary'}
      ...
      },
      {
        ...
        cell: ({ row: { original } }) => (
          <div className="flex justify-center">
            <ActionRenderer
              params={original}
              deleteElement={<DeductionCategoryDelete />}
              updateElement={<span />}
              formId="category"
              modal={modal}
            />

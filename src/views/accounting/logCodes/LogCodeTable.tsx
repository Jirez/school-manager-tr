...
import LogCodeDelete from '@/views/accounting/logCodes/LogCodeDelete'
import type { LogCodeType } from './LogCode.type'
import CommonTable from '@/@core/components/react-table/common-react-table'

const LogCodeTable: FC<CommonTableProps> = (props) => {
  const { t } = useTranslation()

  const columns = useMemo<ColumnDef<LogCodeType>[]>(
    () => [
      {
        accessorKey: 'name',
        header: () => t('label-name'),

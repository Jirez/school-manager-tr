...
const QuarterlyCompNotes = () => {
  ...
  useTitle(t('sidebar.marks.quarterlyCompNotes'))
    ...
    <div className="flex flex-col w-full px-1 md:!px-0">
      <div>
        <div className="w-full">
          <div id="displayStudentName" className="">
            {' '}
          </div>
          <PageHeader title={t('sidebar.marks.quarterlyCompNotes')} />
        </div>
...
export default QuarterlyCompNotes

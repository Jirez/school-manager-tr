...
import CompetenceAdd from '@/views/mark/expectedCompetences/CompetenceAdd'
...
import {
  ...
  useExpectedCompetencesQuery,
  usePeriodsQuery,
} from '@/gql/graphql'

const Competences = () => {
  const { t } = useTranslation()
  useTitle(t('sidebar.marks.expectedCompetences'))
        ...
        <div className="w-full">
          {loadingCompetence ? (
            ...
            <div className="card" style={{ marginTop: 20 }}>
              <CompetenceAdd
                competences={dataCompetence?.expectedCompetences}
                classId={clazz.id}
                period={period.id}
              />
            </div>

...
import {
  ...
  useAnnualCompNoteCalculationMutation,
  useAnnualCompNotesCalculationMutation,
  useClassesForNoteQuery,
  useSchoolYearsQuery,
} from '@/gql/graphql'

const AnnualCompNoteCalculation = () => {
  ...
  return (
    <div className="flex flex-col w-full px-1 md:!px-0">
      <div className="w-full">
        <PageHeader title={t('sidebar.marks.compNoteCalculation')} />
      </div>
...
export default AnnualCompNoteCalculation

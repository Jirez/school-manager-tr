...
import {
  ...
  usePeriodsQuery,
  useQuarterlyAverageCalculationMutation,
  useQuarterlyAveragesCalculationMutation,
} from '@/gql/graphql'

const QuarterlyAverageCalculation = () => {
...
export default QuarterlyAverageCalculation

  ...
  return (
    <>
      {fields.map((field, index) => (
        <td key={`${field.id}`}>
          <SimpleInput
            {...register(`items.${nestIndex}.items.${index}.evalTypeId`)}
            readOnly={true}
            className="d-none"
          />
          <SimpleInput
            {...register(`items.${nestIndex}.items.${index}.evalTypeName`)}
            readOnly={true}
            className="d-none"
          />
          <SimpleInput
...
export default PSequentialNoteItem
